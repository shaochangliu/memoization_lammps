...
extern long total_jj_loops;
extern long total_ev_tally_calls;
std::ofstream outfile_jj;
...
void Run::command(int narg, char **arg)
{
  ...
  outfile_jj.open("output_jj.txt", std::ios::out | std::ios::app); // append mode
  ...
  printf("Total jj loops: %ld\n", total_jj_loops);
  printf("Total ev_tally calls: %ld\n", total_ev_tally_calls);
